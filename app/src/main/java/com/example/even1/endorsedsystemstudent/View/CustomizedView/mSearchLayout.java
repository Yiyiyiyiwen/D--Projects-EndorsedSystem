...
public class mSearchLayout extends LinearLayout {
    ...
    public mSearchLayout(Context context, AttributeSet attrs) {
        ...
        msearch_hint = ta.getString(com.czp.searchmlist.R.styleable.searchmlist_search_hint);
        msearch_baground = ta.getResourceId(com.czp.searchmlist.R.styleable.searchmlist_search_baground, com.czp.searchmlist.R.drawable.search_baground_shap);
        ta.recycle();
    ...
    private void  InitView(){
        ...
        backtitle=getResources().getString(com.czp.searchmlist.R.string.search_cancel);
        searchtitle=getResources().getString(com.czp.searchmlist.R.string.search_verify);


        searchview =(LinearLayout) LayoutInflater.from(context).inflate(com.czp.searchmlist.R.layout.msearchlayout, null);
        //把获得的view加载到这个控件中
        addView(searchview);
        //把两个按钮从布局文件中找到
        ib_searchtext_delete = (ImageView) searchview.findViewById(com.czp.searchmlist.R.id.ib_searchtext_delete);
        ...
        gridviewolddata=  (selfSearchGridView)searchview.findViewById(com.czp.searchmlist.R.id.gridviewolddata);
...
//        countOldDataSize = OldDataList.size();
        ...
        {
            TextView tv = (TextView) mInflater.inflate(com.czp.searchmlist.R.layout.suosou_item,hotflowLayout, false);
