...
import com.example.even1.endorsedsystemstudent.Adapter.MyClassAdapter;
    ...
    private android.os.Handler handler = new android.os.Handler() {
        public void handleMessage(Message msg) {
            if (msg.what == IS_FINISH) {
                SimpleAdapter sadapter = new SimpleAdapter(getApplicationContext(),list,R.layout.class_item,
                        new String[]{"pic","name"},
